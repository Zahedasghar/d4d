...
pdf_path <- "cpi_urban_groupwise.pdf"
...
write_csv(cpi_wide,        "data/cpi_urban_groupwise_wide.csv")
write_csv(cpi_monthly,     "data/cpi_urban_groupwise_tidy_monthly.csv")
write_csv(cpi_annual_avg,  "data/cpi_urban_groupwise_tidy_annual.csv")
