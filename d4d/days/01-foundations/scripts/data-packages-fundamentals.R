...
readxl::read_excel(here::here("data/defense.xlsx")) %>%
  as.data.frame() -> military_data

# Importing CSV file

readr::read_csv(here::here("data/education_analysis.csv")) %>%
...
library(sf)
pakistan_sf <- sf::st_read(here::here("data/admn_shp/District_Boundary.shp"))
