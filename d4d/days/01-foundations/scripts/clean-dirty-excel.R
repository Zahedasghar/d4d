...
#write_excel_csv(nurses, here::here("data/nurses.csv"))
...
# dirty_excel <- read_excel(here::here("data/dirty_data.xlsx"))
dirty_excel <- read_excel(here::here("data/dirty_data.xlsx"), skip = 1) 
dirty_excel|> 
  clean_names() |> 
  remove_empty() |> 
